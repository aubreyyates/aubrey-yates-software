...
const RadAnat = () => {
  return (
    <ProjectPage project={project} technologies={technologies} links={links}>
      Rad Anat is an Electron JS application developed for the University of Iowa College of Dentistry. The application show cases radiology
      illustrations by Assata Worrell. The project overseen by Dr. Sindhura Anamali. The application is a set of learning modules for
      College of Dentistry students to use. The applications user interface is beautifully crafted to contain a modern app look and feel.
      <br />
      <br />
